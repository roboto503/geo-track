...
public class DatabaseHelper extends SQLiteOpenHelper{
	...
	private static final String DATABASE_CREATE = "create table " + TABLE_LOCATION + " (" + COLUMN_ID + " integer primary key autoincrement, " + COLUMN_LON + " text not null, " + COLUMN_LAT + " text not null, " + COLUMN_GEOTAG + " text not null);";	
